...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          window.location.href = "/blog/2025/ai-act-prohibited-practices/";
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%69%70%6F%73%6F%76%61.%61%6E%64%72%65%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/andreasiposova", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/siposova-andrea", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-2908-5813", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=j4ciq8AAAAJ", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
